	...
	menuItems = [
		{
			...
			context: "LIBRARY",
			itemHandlerData: {
				getData: $N.app.PortalUtil.getWindowDataForRecordings,
				activationObject: {
					mode: "PVR"
				},
				refreshOnFocus: true
			...
			logo: "../../../customise/resources/images/net/menu_portal_gravador_b.png",
			logoHighlight: "../../../customise/resources/images/net/menu_portal_gravador_w.png"
		}, {
			title: "menuUSBPlayback",
			active: $N.app.UsbBrowserHelper.getMediaPlaybackStatus,
			...
			logo: "../../../customise/resources/images/net/usb_blue.png",
			logoHighlight: "../../../customise/resources/images/net/usb.png"
		}, {
			title: "menuMusic",
			context: "MUSIC",
			itemHandlerData: {
			...
			logo: "../../../customise/resources/images/net/menu_portal_musica_b.png",
			logoHighlight: "../../../customise/resources/images/net/menu_portal_musica_w.png"
		}, {
			title: "menuMessages",
			context: "MESSAGES",
			itemHandlerData: {
				...
				activationObject: {
					mode: "messages",
					id: "portalMenuMessages"
				}
			},
			logo: "../../../customise/resources/images/net/menu_portal_msg_b.png",
			logoHighlight: "../../../customise/resources/images/net/menu_portal_msg_w.png",
			logoIndicator: "../../../customise/resources/images/net/new_msg_blue.png",
			logoIndicatorHighlight: "../../../customise/resources/images/net/new_msg_white.png"
		}, {
			title: "menuSettings",
			context: "SETTINGS",
			itemHandlerData: {
			...
			logo: "../../../customise/resources/images/net/menu_portal_config_b.png",
			logoHighlight: "../../../customise/resources/images/net/menu_portal_config_w.png"
		}, {
			title: "menuSearch",
			context: "SEARCH",
			itemHandlerData: {
			...
			logo: "../../../customise/resources/images/net/menu_portal_busca_unfocus.png",
			logoHighlight: "../../../customise/resources/images/net/menu_portal_busca_focus.png"
		}, {
			title: "menuHomeNetwork",
			active: isHomeNetworkActive,
			context: "MEDIABROWSER",
			itemHandlerData: {
				getData: null,
				activationObject: {
					mode: "dlna",
					helper: $N.app.DlnaHelper
				}
			},
			logo: "../../../customise/resources/images/net/network_blue.png",
			logoHighlight: "../../../customise/resources/images/net/network.png"
		}
	];
